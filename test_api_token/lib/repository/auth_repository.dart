...
class AuthRepository {
  ...
  final _targetUrl =
      'http://${Platform.isAndroid ? '10.100.204.26' : 'localhost'}:8080/apiserver';
  ...
  Future<({String refreshToken, String accessToken})> register({
    ...
    return (
      refreshToken: result.data as String,
      accessToken: result.data as String,
    );
  }
  ...
  // Refresh Token을 Header에 담아서 Refresh Token 재발급(갱신) URL에 요청을 보냅니다.
  ...
  // Refresh Token을 Header에 담아서 Access Token 재발급(갱신) URL에 요청을 보냅니다.
